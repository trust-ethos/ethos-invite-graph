  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'retro-glow': {
          'from': { 
            boxShadow: '0 0 20px rgba(0, 206, 209, 0.5), 0 0 40px rgba(138, 43, 226, 0.3)' 
          },
          'to': { 
            boxShadow: '0 0 30px rgba(0, 206, 209, 0.8), 0 0 60px rgba(138, 43, 226, 0.5)' 
          },
        },
        'slide-in': {
      ...
      backgroundImage: {
        'retro-pattern': `url("data:image/svg+xml,%3csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3e%3cg fill='none' fill-rule='evenodd'%3e%3cg fill='%2300CED1' fill-opacity='0.1'%3e%3cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3e%3c/g%3e%3c/g%3e%3c/svg%3e")`,
        'cup-swoosh': 'linear-gradient(45deg, #00CED1 0%, #8A2BE2 50%, #FF1493 100%)',
        'retro-gradient': 'linear-gradient(135deg, #00FFFF 0%, #8A2BE2 25%, #FF1493 50%, #FFD700 75%, #32CD32 100%)',
      },
      boxShadow: {
