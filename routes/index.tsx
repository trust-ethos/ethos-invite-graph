...
export default function Home({ url }: PageProps) {
  ...
  return (
    <div class="min-h-screen bg-gradient-to-br from-offwhite via-cream to-retro-teal/10 relative overflow-hidden">
      ...
      <div class="absolute top-20 left-10 w-32 h-32 bg-retro-teal rounded-full opacity-20 animate-bounce-slow z-0"></div>
      <div class="absolute top-40 right-20 w-24 h-24 bg-retro-purple transform rotate-45 opacity-25 animate-wiggle z-0"></div>
      <div class="absolute bottom-32 left-1/4 w-28 h-28 bg-retro-magenta rounded-full opacity-15 animate-pulse-fast z-0"></div>
      <div class="absolute top-60 right-1/3 w-20 h-40 bg-retro-cyan transform -rotate-12 opacity-20 animate-bounce-slow z-0" style="animation-delay: 1s;"></div>
      ...
      <div class="relative z-10 container mx-auto px-6 py-16">
        ...
        <div class="text-center mb-16">
          <div class="inline-block mb-8">
            ...
            <div class="w-full h-2 bg-retro-teal mt-4 transform rotate-1 shadow-retro"></div>
          </div>
        ...
        <div class="max-w-2xl mx-auto mb-40 relative z-20">
          <div class="bg-white/90 backdrop-blur-sm border-4 border-retro-teal rounded-3xl p-8 shadow-retro-lg transform rotate-1 hover:rotate-0 transition-transform duration-300">
            {/* Retro accent line */}
            <div class="h-4 bg-gradient-to-r from-retro-teal via-retro-purple to-retro-magenta rounded-full mb-6 animate-pulse-fast"></div>
        ...
        <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16 relative z-10">
          <div class="group text-center p-8 bg-white/80 backdrop-blur-sm border-4 border-retro-cyan rounded-2xl shadow-retro hover:shadow-retro-lg transition-all duration-300 transform hover:scale-105 hover:-rotate-1">
            ...
            <h3 class="text-xl font-retro text-retro-purple mb-3 font-black">SUPER SEARCH</h3>
            <p class="text-gray-700 font-bold">Find users with our totally awesome search engine!</p>
          </div>
          ...
          <div class="group text-center p-8 bg-white/80 backdrop-blur-sm border-4 border-retro-purple rounded-2xl shadow-retro hover:shadow-retro-lg transition-all duration-300 transform hover:scale-105 hover:rotate-1">
            ...
            <h3 class="text-xl font-retro text-retro-cyan mb-3 font-black">NETWORK MAPPING</h3>
            <p class="text-gray-700 font-bold">Explore radical trust connections and invitations!</p>
          </div>
          ...
          <div class="group text-center p-8 bg-white/80 backdrop-blur-sm border-4 border-retro-magenta rounded-2xl shadow-retro hover:shadow-retro-lg transition-all duration-300 transform hover:scale-105 hover:-rotate-1">
            ...
            <h3 class="text-xl font-retro text-retro-teal mb-3 font-black">VISUAL STATS</h3>
            <p class="text-gray-700 font-bold">See your network data in totally tubular graphs!</p>
          </div>
        </div>
        ...
        <div class="mt-16 flex justify-center space-x-8 relative z-10">
          <div class="w-8 h-8 bg-retro-cyan transform rotate-45 animate-pulse-fast"></div>
          <div class="w-8 h-8 bg-retro-purple rounded-full animate-bounce-slow"></div>
          <div class="w-8 h-8 bg-retro-magenta transform rotate-45 animate-wiggle"></div>
          <div class="w-8 h-8 bg-retro-teal rounded-full animate-pulse-fast"></div>
        </div>
      </div>
    </div>
  );
